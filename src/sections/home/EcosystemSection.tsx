          ...
          <Reveal direction="left">
            <div style={{ position: "relative", height: 440 }}>
              ...
              <motion.div
                ...
                style={{ position: "absolute", left: "50%", top: "46%", transform: "translate(-50%,-50%)", width: 76, height: 76, borderRadius: "50%", border: `1.5px solid ${T.navyLight}`, background: `radial-gradient(circle, rgba(61,82,160,0.22), transparent)`, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", zIndex: 3 }}
              >
                ...
                return (
                  <motion.div
                    ...
                    style={{
                      ...
                      border: `1.5px solid ${active === p.id ? p.color : "rgba(112,145,230,0.2)"}`,
              ...
              {ap ? (
                <motion.div key={ap.id} initial={{ opacity: 0, x: 18 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -18 }} transition={{ duration: 0.32 }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 0, marginBottom: 28 }}>
                    {ap.modules.map(m => (
                      <div key={m} style={{ display: "flex", alignItems: "center", gap: 9, padding: "10px 0", borderBottom: "1px solid rgba(112,145,230,0.1)" }}>
                  ...
                  <div style={{ display: "flex", gap: 12 }}>
                    ...
                    <a href="#" style={{ padding: "11px 24px", border: "1.5px solid rgba(112,145,230,0.28)", color: T.textSecondary, fontFamily: T.sans, fontSize: 13, fontWeight: 500, borderRadius: 100, textDecoration: "none" }}>Request Demo</a>
                  </div>
                </motion.div>
              ) : (
                <motion.div key="empty" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                  style={{ padding: "44px 40px", border: "1px dashed rgba(112,145,230,0.18)", borderRadius: 12, textAlign: "center" }}
                >
