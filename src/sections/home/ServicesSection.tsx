        ...
        <Reveal>
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: 60, flexWrap: "wrap", gap: 20 }}>
            <div>
              ...
              <h2 style={{ fontFamily: T.sans, fontSize: "clamp(28px, 3.4vw, 46px)", fontWeight: 700, color: T.ink, letterSpacing: "-0.025em", lineHeight: 1.12, marginBottom: 12 }}>Our Services</h2>
              <p style={{ fontFamily: T.sans, fontSize: 15, color: "#3D4A6E", maxWidth: 660, fontWeight: 300, lineHeight: 1.6 }}>
                Full-cycle engineering, customization, and strategic advisory services required to deploy and extend our proprietary platforms, plus broader enterprise technology consulting.
              </p>
            </div>
